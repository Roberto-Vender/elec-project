          ...
          <tbody>
            ...
            <tr className="hover:bg-gray-100">
              ...
              <td className="py-2 px-4 text-center">
                <button className="bg-red-600 text-white rounded-full w-28 h-8">Disabled</button>
              </td>
              <td className="py-2 px-4 text-center">
                <div className="flex justify-center space-x-2">
                  <a href="#" className="text-blue-600 hover:underline">Enable Account</a>
                  <a href="#" className="text-red-500 hover:underline">Disable Account</a>
                </div>
              </td>
            </tr>
            ...
            <tr className="hover:bg-gray-100">
              ...
              <td className="py-2 px-4 text-center">Provider</td>
              <td className="py-2 px-4 text-center">
                <button className="bg-green-600 text-white rounded-full w-28 h-8">Enabled</button>
              </td>
              <td className="py-2 px-4 text-center">
                <div className="flex justify-center space-x-2">
                  <a href="#" className="text-blue-600 hover:underline">Enable Account</a>
            ...
            <tr className="hover:bg-gray-100">
              ...
              <td className="py-2 px-4 text-center">Customer</td>
              <td className="py-2 px-4 text-center">
                <button className="bg-green-600 text-white rounded-full w-28 h-8">Enabled</button>
              </td>
              <td className="py-2 px-4 text-center">
